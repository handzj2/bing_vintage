...
import { Repository, Connection, Between, MoreThanOrEqual } from 'typeorm'; // 👈 Added missing imports
...
export class PaymentsService {
  ...
  async create(createPaymentDto: CreatePaymentServiceDto) {
    ...
    // ✅ Fixed: Use loanId instead of loan object and cast paymentMethod
    const payment = this.paymentRepo.create({
      loanId: createPaymentDto.loanId,  // ✅ Use FK instead of object
      amount: createPaymentDto.amount,
      paymentMethod: createPaymentDto.paymentMethod as any,  // ✅ Cast enum
      receiptNumber,
      ...
      scheduleId: createPaymentDto.scheduleId, // 👈 Added scheduleId
    });
  ...
  async getTodayPayments() {
    ...
    return await this.paymentRepo.find({ 
      where: { paymentDate: MoreThanOrEqual(today) }, 
      relations: ['loan', 'loan.client'],
