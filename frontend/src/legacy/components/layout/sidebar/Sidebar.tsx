...
import {
  ...
  Menu,
  X,
  RotateCcw, // 1. Added for Reversals
} from 'lucide-react';
...
const navigation = [
  ...
  // 2. Added Reversals & Edits tab restricted to Admin role
...
export default function Sidebar() {
  ...
  const { user, logout } = useAuth(); // Accessing user role from AuthContext
  ...
  return (
    <>
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col lg:border-r lg:border-gray-200 lg:bg-white lg:pb-4">
        ...
        {/* User Info with Correct Field Mapping */}
        {user && (
        ...
        {/* Navigation - Uses Filtered Items */}
